...
package tech.blur.nstuctf.core.cicerone;
...
public abstract class AndroidxAppNavigator extends AndroidxFragmentNavigator {

    private Activity activity;

    public AndroidxAppNavigator(FragmentActivity activity, int containerId) {
        super(activity.getSupportFragmentManager(), containerId);
        this.activity = activity;
    }

    public AndroidxAppNavigator(FragmentActivity activity, FragmentManager fragmentManager, int containerId) {
